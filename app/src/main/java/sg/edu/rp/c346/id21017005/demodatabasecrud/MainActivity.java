package sg.edu.rp.c346.id21017005.demodatabasecrud;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // LINE 30: This line checks for error, if it is -1 then there is an insertion error
                if(inserted_id != -1){
                    // LINE 31: This line clears the ArrayList before adding anything new
                    al.clear();
